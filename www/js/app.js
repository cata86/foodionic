...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab.accompagnatore', {
    url: '/accompagnatore',
    views: {
      'accompagnatore': {
        templateUrl: 'templates/accompagnatore.html',
        controller: 'AccompagnatoreCtrl'
      }
    }
  })
  ...
  .state('ingredientiPietanza', {
    url: '/ingredientiPietanza/:pietanzaId',
    views: {
      'ingredientiPietanza': {
        templateUrl: 'templates/modifica-pietanza.html',
        controller: 'ModificaPietanzaCtrl'
      }
    }
  })
